...
const ProgramCard = ({strategy}) =>{
    ...
    return(
        <div className="col-sm-3 mb-3 text-center">
            <div className="container bg-light d-flex flex-column justify-content-between rounded-3 h-100 pb-1">
                <div className="row" >
...
export default function ProgramManagement(props){
    ...
    useEffect(()=>dispatch(getStrategies({plant, year})),[dispatch,plant, year])
    ...
    return(
        <div className="container">
            ...
            {create && <NewProgram
                ...
                plant={props.plant}
                />}
            {programList && <div className="container">
                <div className="row">
